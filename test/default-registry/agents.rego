package main
agents := {
  "base": {"container": "base", "image": "ghcr.io/amamba-io/jenkins-agent-base:latest-podman"},
  ...
  "python": {"container": "python", "image": "ghcr.io/amamba-io/jenkins-agent-python:latest-3.8.19-podman"},
  ...
  "nodejs": {"container": "nodejs", "image": "ghcr.io/amamba-io/jenkins-agent-nodejs:latest-16.20.2-podman"},
